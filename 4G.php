...
<div class="row">
    <div class="col-sm-10">
        ...
        <button type="submit" class="btn btn-success" name="submit104"> Submit</button>
         &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp
         <button type="submit" class="btn btn-link" name="export_excel12" style="color:black" formaction="/Exceldownload.php"><b>Excel Download</b></button>
    </div>
</div>   
