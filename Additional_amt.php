...
<div class="container" >
 ...
 <div class="row"  >
      ...
      <div class="col-sm-8"   >
          <div class="row">
          <label style="margin-left:250px;" ><b>Add Ammount</b></label>
        </div>
        <div class="row" style="margin-left: 250px;" >
          <input type="text"  name="ammount1" placeholder="ammount" id="one" >&nbsp
          <input type="text"  name="remark1" placeholder="remark"  >
      </div>
        ...
        <div class="row" style="margin-left:250px;">
          <input type="text"  name="ammount2" placeholder="ammount" id="two">&nbsp
          <input type="text"  name="remark2" placeholder="remark" >
          </div>
      ...
      <br>
       ...
       <div class="col-sm-8"  >
        ...
        <div class="row" style="margin-left:250px;">
          <input type="text"  name="ammount3" id="three" placeholder="ammount">&nbsp
          <input type="text"  name="remark3" placeholder="remark" >
        ...
        <div class="row" style="margin-left:250px;">
          <input type="text"  name="ammount4" placeholder="ammount" id="four">&nbsp
          <input type="text"  name="remark4" placeholder="remark">
    ...
    <div class="col-sm-6" style="margin-left:250px;" >
      ...
      <div class="row">
        <div class="col-sm-10" style="margin-left:250px;">
          ...
          <button type="submit" class="btn btn-success" name="submit121"> Submit</button>
          &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
          <button type="submit" class="btn btn-link" name="export_excel17" style="color:black" formaction="/Exceldownload.php"><b>Excel Download</b></button>
        </div>
        </div>   
