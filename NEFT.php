    ...
    <div class="col-sm-6" style="margin-left:250px;" >
      ...
      <div class="row">
        <div class="col-sm-10" style="margin-left:250px;">
          ...
          <button type="submit" class="btn btn-success" name="submit125"> Submit</button>
          &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
          <button type="submit" class="btn btn-link" name="export_excel22" style="color:black" formaction="/Exceldownload.php">Excel Download</button>
        </div>
        </div>   
