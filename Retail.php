...
<div class="col-sm-8">
    <div class="row" style="margin-left: 250px;" >
        <input type="text"  name="retail1" placeholder="Retail" id="one" >&nbsp
...
<div class="col-sm-8"  >
    <div class="row" style="margin-left:250px;">
        <input type="text"  name="retail2" placeholder="Retail" id="two">&nbsp
...
<div class="col-sm-8"  >
    <div class="row" style="margin-left:250px;">
        <input type="text"  name="retail3" id="three" placeholder="Retail">&nbsp
...
<div class="col-sm-8"  >
    <div class="row" style="margin-left:250px;">
        <input type="text"  name="retail4" placeholder="Retail" id="four">&nbsp
...
<div class="row">
    <div class="col-sm-10" style="margin-left:250px;">
        ...
        <button type="submit" class="btn btn-success" name="submit127"> Submit</button>
        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
        <button type="submit" class="btn btn-link" name="export_excel23" style="color:black" formaction="/Exceldownload.php"><b>Excel Download</b></button>
    </div>
</div>   
