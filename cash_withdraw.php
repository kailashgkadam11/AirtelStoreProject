...
<div class="row">
    <div class="col-sm-10">
        ...
        <button type="submit" class="btn btn-success" name="submit_withdraw"> Submit</button>
        &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp
          
        <button type="submit" class="btn btn-link" name="export_excel16" style="color:black" formaction="/Exceldownload.php"><b>Excel Download</b></button>
    </div>
</div>   
