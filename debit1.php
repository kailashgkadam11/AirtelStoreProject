    ...
    <div class="col-sm-6" style="margin-left:250px;" >
      ...
      <div class="row">
        <div class="col-sm-10" style="margin-left:250px;">
            ...
            <button type="submit" class="btn btn-success" name="submit122"> Submit</button>
            &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
            <button type="submit" class="btn btn-link" style="color:black" name="export_excel18" formaction="/Exceldownload.php"><b>Excel Download</b></button>
        </div>
        </div>   
