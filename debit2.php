...
<div class="col-sm-8"   >
    <div class="row" style="margin-left: 250px;" >
        <input type="text"  name="ammount1" placeholder="Amount" id="one" >&nbsp
...
<div class="col-sm-8"  >
    <div class="row" style="margin-left:250px;">
        <input type="text"  name="ammount2" placeholder="Amount" id="two">&nbsp
...
<div class="col-sm-8"  >
    <div class="row" style="margin-left:250px;">
        <input type="text"  name="ammount3" id="three" placeholder="Amount">&nbsp
...
<div class="col-sm-8"  >
    <div class="row" style="margin-left:250px;">
          <input type="text"  name="ammount4" placeholder="Amount" id="four">&nbsp
...
<div class="row">
    <div class="col-sm-10" style="margin-left:250px;">
        ...
        <button type="submit" class="btn btn-success" name="submit123"> Submit</button>
        &nbsp &nbsp &nbsp &nbsp &nbsp 
        <button type="submit" class="btn btn-link" name="export_excel21" style="color:black " formaction="/Exceldownload.php"><b>Excel Download</b></button>
    </div>
</div>   
