...
<div class="row">
    <div class="col-sm-10" style="margin-left:250px;">
        ...
        <button type="submit" class="btn btn-success" name="submit124"> Submit</button>
        &nbsp &nbsp &nbsp &nbsp &nbsp
        <button type="submit" class="btn btn-link" name="export_excel20" style="color:black" formaction="/Exceldownload.php"><b>Excel Download</b></button>
    </div>       
</div>   
