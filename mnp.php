...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="name1" placeholder="Customer Name" >
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="name2" placeholder="Customer Name">
    </div> 
</div>
<br>
...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="name3" placeholder="Customer Name" >
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="name4" placeholder="Customer Name" >
    </div>
<br>
...
<div class="row">
    <div class="col-sm-10">
        ...
        <button type="submit" class="btn btn-success" name="submit102"> Submit</button>
        &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp&nbsp &nbsp &nbsp
        <button type="submit" class="btn btn-link" name="export_excel10" style="color:black" formaction="/Exceldownload.php"><b>Excel Download</b></button>
    </div>
</div>   
