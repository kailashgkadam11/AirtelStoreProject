...
<script language="javascript">
  ...
  function totalbal() {
    ...
    total1.value= one + two + three + four + five + six ;
    // body...
  }
...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="new_number1" placeholder="Customer Number">&nbsp
        <input type="text"  name="new_name1" placeholder="Customer Name">
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="new_number2" placeholder="Customer Number">&nbsp
        <input type="text"  name="new_name2" placeholder="Customer Name">
    </div> 
</div>
<br>
...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="new_number3" placeholder="Customer Number" >&nbsp
        <input type="text"  name="new_name3" placeholder="Customer Name">
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="new_number4" placeholder="Customer Number" >&nbsp
        <input type="text"  name="new_name4" placeholder="Customer Name" >
    </div>
<br>
    
    <div class="row">
        &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
        <button type="submit" class="btn btn-success" name="submit101">Submit</button>
        &nbsp &nbsp &nbsp &nbsp &nbsp
        <button type="submit" class="btn btn-link" name="export_excel9" style="color:black" formaction="/Exceldownload.php">Excel Download</button>
    </div>
</div>   
<br>
