...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="ammount1"  placeholder="Customer Number">&nbsp
        <input type="text"  name="reason1" placeholder="Amount">
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="ammount2" placeholder="Customer Number" >&nbsp
        <input type="text"  name="reason2" placeholder="Amount" >
    </div> 
</div>
<br>
...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="ammount3" placeholder="Customer Number">&nbsp
        <input type="text"  name="reason3" placeholder="Amount" >
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        <input type="text"  name="ammount4" placeholder="Customer Number">&nbsp
        <input type="text"  name="reason4"  placeholder="Amount">
    </div>
<br>
</div>        
...
<div class="row">
    <div class="col-sm-10">
        ...
        <button type="submit" class="btn btn-success" name="submit5"> Submit</button>
        &nbsp &nbsp &nbsp &nbsp &nbsp
        <button type="submit" class="btn btn-link" name="export_excel13" style="color:black" formaction="/Exceldownload.php"><b>Excel Download</b></button>
    </div>
</div>   
