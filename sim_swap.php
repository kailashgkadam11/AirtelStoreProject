...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="ammount1" placeholder="Amount" id="one">
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="ammount2" placeholder="Amount" id="two" >
    </div> 
</div>
<br>
...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="ammount3" placeholder="Amount" id="three">
    </div>
</div>   
<br>
...
<div class="col-sm-8">
    <div class="row">
        ...
        <input type="text"  name="ammount4"  placeholder="Amount" id="four">
    </div>
<br>
...
<div class="row">
    <div class="col-sm-10">
        ...
        <button type="submit" class="btn btn-success" name="submit103"> Submit</button>
         &nbsp &nbsp &nbsp &nbsp &nbsp
         <button type="submit" class="btn btn-link" name="export_excel10" style="color:black" formaction="/Exceldownload.php">Excel Download</button>
    </div>
</div>   
